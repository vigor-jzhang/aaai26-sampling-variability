...
class AmosCTMRIDataset(torch.utils.data.Dataset):
    def __init__(self, config):
        ...
        # data parameters
        self.dataloader_len = config.dataloader.batchs_num * config.dataloader.batch_size
        self.nii_prefix = config.dataloader.data_root_dir
...
def AmosCTMRIDataloader(config):
    dataloader = AmosCTMRIDataset(config)
